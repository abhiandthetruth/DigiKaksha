            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default  dropdown-menu-right ">
                <div class="row shortcuts px-4">
                  <a href="/courses" class="col-4 shortcut-item">
                    <span class="shortcut-media avatar rounded-circle bg-gradient-green">
                      <i class="ni ni-books"></i>
                    </span>
                    <small>Courses</small>
                  </a>
                  <a href="https://gmail.com" class="col-4 shortcut-item">
                    <span class="shortcut-media avatar rounded-circle bg-gradient-orange">
                      <i class="ni ni-email-83"></i>
                    </span>
                    <small>Email</small>
                  </a>
                  <a href="/groups" class="col-4 shortcut-item">
    ...
    <div class="header pb-6 d-flex align-items-center" style="min-height: 500px; background-image: url(../../assets/img/theme/img-1-1000x600.jpg); background-size: cover; background-position: center top;">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          ...
          <h1 class="display-2 text-white">{{$group->name}}</h1>
            <p class="text-white mt-0 mb-5">This is the showcase page for the class {{$group->name}}. You can see all the class related information here.</p>
            @if(Auth::user()->user_level==3)
                <a href="/groups/{{$group->id}}/edit" class="btn btn-neutral">Edit Class</a>
            @endif
         </div>
        </div>
      </div>
          ...
          <div class="card card-profile">
            ...
            <div class="card-body pt-0">
              <div class="row">
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center">
                    <div>
                    <span class="heading">{{$group->group_code}}</span>
                      <span class="description">Group ID</span>
                    </div>
                    <div>
                      <span class="heading">{{count($group->courses)}}</span>
                      <span class="description">Courses</span>
                    </div>
                    <div>
                    <span class="heading">{{count($group->users)}}</span>
              ...
              <div class="text-center">
                <h5 class="h3">
                 {{$group->name}}<span class="font-weight-light"></span>
                </h5>
                <div class="h5 mt-4">
                ...
                <ul class="list-group list-group-flush list my--3">
                    ...
                    <li class="list-group-item px-0">
                      <div class="row align-items-center">
                        ...
                        <div class="col">
                          <h5>{{$student->roll_no}}: {{$student->name}}</h5>
                        </div>
                      </div>
                    </li>
                    @endforeach
